...
import es.medac.miedadcanina.BR;
...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.fondoGif, 1);
        sViewsWithIds.put(R.id.urEdad, 2);
        ...
        sViewsWithIds.put(R.id.btnClear, 13);
        sViewsWithIds.put(R.id.btn0, 14);
        sViewsWithIds.put(R.id.btnDel, 15);
        sViewsWithIds.put(R.id.boton, 16);
    }
    // views
    // variables
    // values
    ...
    private ActivityMainBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (pl.droidsonroids.gif.GifImageView) bindings[1]
